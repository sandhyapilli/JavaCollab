package com.example.fileProcessor;
	...
	public class FileProcessorController {
	    ...
	    public ResponseEntity<List<String>> processFile(
	            ...
	            @RequestParam(value = "startRow", defaultValue = "0") int startRow, @RequestParam(value="ColumnName", defaultValue="0") String ColumnName) {
	        try {
	            List<String> processedData = fileProcessorService.processFile(file, startRow, ColumnName);
